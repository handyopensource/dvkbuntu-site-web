        ...
        if($titrelenght <= 255 AND $descriptionlenght <= 5000)
        {
            ...
            {  
                ...
                if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
                {
                    ...
                    {                 
                        $req = $bdd->prepare('UPDATE documents SET titre = :titre, description = :description, image = :image, valider = 1 WHERE id = :id');
                        $req->execute(array(
                                'titre' => $titre,
                        ...
                        $message_txt = "Votre tutoriel a bien été validé";
                        $message_html = "Votre tutoriel a bien été validé ! /n
                        <html>
                        <head>
                        <meta charset=\"utf-8\"/>
                        </head>
                        <body>
                        <div align=\"center\">
                        <font color=\"#003DB3\"><h1>Votre tutoriel a bien été validé par un administrateur, merci de votre participation !</h1></font><br/>
                        </div>
                        <hr>
                        <small>
            ...
            {
                $req = $bdd->prepare('UPDATE documents SET titre = :titre, description = :description, valider = 1 WHERE id = :id');
                        $req->execute(array(
                                'titre' => $titre,
                                'description' => $description,
                                'id' => $getid
					...
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									...
									<ul class="icons">
                                       <li><a href="mode.php?id=20" style="color: yellow; background-color: black;">Mode malvoyant : </a>&nbsp;<a href="mode.php" style="color:#000000" alt="Changer les contrastes"><i class="fas fa-low-vision fa-lg" id="icone_oeil"></i></a></li>
                        ...
                        <!-- Content -->
								<section>
                                    ...
                                    <header class="main">
										<h1>Valider une documentation</h1>
                                        <strong>
                                        <font color="red">
                                        <?php if(isset($erreur))
                                        {
