	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									...
									<ul class="icons">
                                       <li><a href="mode.php?id=11" style="color: yellow; background-color: black;">Mode malvoyant : </a>&nbsp;<a href="mode.php" style="color:#000000" alt="Changer les contrastes"><i class="fas fa-low-vision fa-lg" id="icone_oeil"></i></a></li>
                        ...
                        <!-- Content -->
								<section>
									<header class="main">
										<h1>Oups.... Quelque chose n'a pas été....</h1>
            ...
            <div class="navbar-bottom">
                <a href="mode.php?id=11" alt="Changer les contrastes"><i class="fas fa-low-vision fa-lg"></i></a>
                &emsp;
