	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
						...
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									...
									<ul class="icons">
                                       <li><a href="mode.php?id=2" style="color: yellow; background-color: black;">Mode malvoyant : </a>&nbsp;<a href="mode.php" style="color:#000000" alt="Changer les contrastes"><i class="fas fa-low-vision fa-lg" id="icone_oeil"></i></a></li>
            ...
            <div class="navbar-bottom">
                <a href="mode.php?id=2" alt="Changer les contrastes"><i class="fas fa-low-vision fa-lg"></i></a>
                &emsp;
				...
				<!-- Main -->
					<div id="main">
                        ...
                        <!-- Content -->
								<section>
									<header class="main">
										<h1>Envie de poster des actualités ? Contactez nous <font color="blue"><a href="#contact">ici</a> </font> pour recevoir une autorisation !</h1>
